...
This content is intended for students who are exploring the role of a design professional as a part of a [Built Environment Innovation Challenge](https://github.com/BEICBIM/BEICPBLChallenge/blob/master/README.md).  **Architects, engineers and other design professionals** provide the essential services for the *visualizion* and *simulation* of the _owner's requirements_, and _coordinated solutions_ to meet them.  In a built environment innovation challange, designers must ensure their visualization and simulation of the owners requirements stays in sync across the network of interdependent relationships among the owner, designer(s), constructor(s) and the various parts, components, and subsystems that comprise the optimal solution.  These services are essential to achieving common understanding and optimizing performance of a built environment project solution that meets or exceeds the owners requirements.

The design deliverable of a built environment innovation challenge is a preliminary version of a *virtual model*.  A key characteristic of this model is that it is *parametric* and can capture, manage, and show relationships between the various parts, components, and subsystems that comprise alternative solutions to a built environment innovation challenge. 
