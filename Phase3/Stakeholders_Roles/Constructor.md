...
#### a. Constructability
Tasks that are **not** realisticaly achievable in the time and space alloted, using readily available equipment, skills, or materials represent potential issues that make successful construction unlikely.  For example, a multi-story structure may not be realistic to construct in a location without sufficient maneuver area for a crane.  In other cases permitting or regulatory requirements may preclude the possibility of certain kinds of construction in certain areas.     
#### b. Main Cost Drivers
