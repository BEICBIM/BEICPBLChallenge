...
This content is intended for students who are exploring the role of a construction manager as a part of a [Built Environment Innovation Challenge](https://github.com/BEICBIM/BEICPBLChallenge/blob/master/README.md).  [Construction Managers](https://youtu.be/jNgsSdRqsh0) play an important role in the built environment industry that spans from early the early planning and development of projects through project execution and delivery.  A Construction Manager who has a good understanding of the basics concepts of project management and control and can apply it early in project planning and development efforts increases the likelihood that the project will be a success.     
